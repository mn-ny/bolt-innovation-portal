...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
  (
    ...
    // Simplified function to split text into characters without using Intl.Segmenter
    const splitIntoCharacters = (text: string): string[] => {
      // Just use the default Array.from implementation which works for most cases
